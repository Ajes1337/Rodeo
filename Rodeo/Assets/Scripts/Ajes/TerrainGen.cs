...
public class TerrainGen : MonoBehaviour {
    ...
    public static Action OnChunkBorderPassd = () => { };
    ...
    private void OnGUI() {
        ...
        if (ShowToolTips) {
            ...
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 100, 300, 20), "ToolTips, Deactivate/Activate on F1");

            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 60, 300, 20), "WASD - Move");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 40, 300, 20), "Arrows - Turn");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 20, 300, 20), "Space/L-Shift - Up/Down");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2, 300, 20), "Q/E - Roll");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 + 20, 300, 20), "CTRL - Shoot");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 + 40, 300, 20), "1-7 - Change Weapon");
            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 + 60, 300, 20), "F6 - Activate Cheat Light");

            AjesGuiLabel(new Rect(Screen.width / 2 - 150, Screen.height / 2 + 100, 300, 22), "TODO: Flyv rundt og Pløk Fjender");
